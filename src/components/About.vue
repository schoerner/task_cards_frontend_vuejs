<template>
    <div>
        <h1>About the Task App</h1>
        <p>
            The didactical <i>Task App</i> was developed for educational research.
        </p>
        <h2>Objectives</h2>
        <ol class="list-group list-group-numbered">
            ...
            <li class="list-group-task d-flex justify-content-between align-tasks-start">
                ...
                And the need of ...
                <ul>
                    <li>@CrossOrigin annotation</li>
                    <li>Tests with Postman</li>
                </ul>
                </div>
                <span class="badge bg-primary rounded-pill">14</span>
            </li>
