    ...
    methods: {
        ...
        async saveEditedItem() {
            ...
            const dataToSave = {
                ...
                description: this.editItemDesccription,
                creator: this.editItemCreator
            }
            ...
            fetch("http://localhost:8088/rest/tasks/" + this.editItemId, requestOptions)
                .then(async response => {
                        ...
                        console.error('updatedAt = ', data.updatedAt);
