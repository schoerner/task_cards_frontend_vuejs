...
export default {
  ...
  created() {
    console.log("EditTask.created, this.task: " + this.task);

    this.editItemTitle = this.task.title
    this.editItemDescription = this.task.description
  },
  activated() {
    console.log("EditTask.activated, task: " + this.task)
  },
  mounted() {
    console.log("EditTask.mounted, task: " + this.task)
  ...
  methods: {
    ...
    async saveEditedItem() {
      ...
      console.log("EditTask.saveEditedItem", this.task);
